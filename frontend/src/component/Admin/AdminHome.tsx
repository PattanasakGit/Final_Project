        ...
        <center>
            <div style={{ height: 'auto', width: '95%', backgroundColor: '#ffffff99' }} className='contentPage'>
                ...
                <div className='container_admin_home'>
                    ...
                    <div id="menu_admin_1" className='menu_admin' onClick={() => window.location.href = PortFrontend + '/AdminCheckProduct'}>
                    ...
                    <div id="menu_admin_2" className='menu_admin' onClick={() => window.location.href = PortFrontend + '/AdminCheckAds'} >
                    ...
                    <div id="menu_admin_3" className='menu_admin' onClick={() => window.location.href = PortFrontend + '/CheckFraudReport'}>
                    ...
                    <div id="menu_admin_3" className='menu_admin' onClick={() => window.location.href = PortFrontend + '/AdminManagement'}>
                    ...
                    <div id="menu_admin_4" className='menu_admin' onClick={() => window.location.href = PortFrontend + '/DataWeb'}>
                    ...
                    <div id="menu_admin_5" className='menu_admin'onClick={() => window.location.href = PortFrontend + '/AdminCategory'} >
                    ...
                    <div id="menu_admin_6" className='menu_admin' onClick={() => window.location.href = PortFrontend + '/AdminTopBanner'}>
                    ...
                    <div id="menu_admin_6" className='menu_admin' onClick={() => window.location.href = PortFrontend + '/HomePage'}>
